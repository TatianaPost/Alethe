...
<div class="social-buttons">
    <div class="addthis_toolbox addthis_default_style">
        ...
        <div class="soc4">
            <div class="pin">
                <a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink() ?>&media=<?php ale_og_meta_image() ?>"
                   class="pin-it-button"
                   count-layout="horizontal"
                   onclick="window.open(this.href, 'Share on Pinterest', 'width=600,height=300'); return false">
