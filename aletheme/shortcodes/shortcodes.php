...
if (!function_exists('ale_one_third_last')) {
	function ale_one_third_last( $atts, $content = null ) {
	   return '<div class="ale-one-third ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_two_third_last')) {
	function ale_two_third_last( $atts, $content = null ) {
	   return '<div class="ale-two-third ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_one_half_last')) {
	function ale_one_half_last( $atts, $content = null ) {
	   return '<div class="ale-one-half ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_one_fourth_last')) {
	function ale_one_fourth_last( $atts, $content = null ) {
	   return '<div class="ale-one-fourth ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_three_fourth_last')) {
	function ale_three_fourth_last( $atts, $content = null ) {
	   return '<div class="ale-three-fourth ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_one_fifth_last')) {
	function ale_one_fifth_last( $atts, $content = null ) {
	   return '<div class="ale-one-fifth ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_two_fifth_last')) {
	function ale_two_fifth_last( $atts, $content = null ) {
	   return '<div class="ale-two-fifth ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_three_fifth_last')) {
	function ale_three_fifth_last( $atts, $content = null ) {
	   return '<div class="ale-three-fifth ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_four_fifth_last')) {
	function ale_four_fifth_last( $atts, $content = null ) {
	   return '<div class="ale-four-fifth ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_one_sixth_last')) {
	function ale_one_sixth_last( $atts, $content = null ) {
	   return '<div class="ale-one-sixth ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_five_sixth_last')) {
	function ale_five_sixth_last( $atts, $content = null ) {
	   return '<div class="ale-five-sixth ale-column-last">' . do_shortcode($content) . '</div>
               <div class="clear"></div>';
	}
...
if (!function_exists('ale_button')) {
	function ale_button( $atts, $content = null ) {
	   ...
	   return '<a target="'.$target.'" 
	              class="ale-button '.$size.' '.$style.' '. $type .'" 
	              href="'.$url.'">' . do_shortcode($content) . '</a>';
	}
...
if (!function_exists('ale_toggle')) {
	function ale_toggle( $atts, $content = null ) {
		...
		return "<div data-id='".$state."' class=\"ale-toggle\">
                     <span class=\"ale-toggle-title\">". $title ."</span>
                    <div class=\"ale-toggle-inner\">". do_shortcode($content) ."</div>
                </div>";
	}
...
if (!function_exists('ale_testimonial')) {
    function ale_testimonial( $atts, $content = null ) {
        ...
        return '<div class="ale-testimonial '.$style.' cf">
                    <div class="lefttestimonialpart">   
                        <div class="avatarimage">
                            <a href="'.$link.'" target="_blank">
                                <img src="'.$avatar.'" />
                             </a>
                        </div>
                        <div class="testititle">'.$name.'</div>
                     </div>
                     <div class="righttestimonialpart">'.do_shortcode($content).'</div>
                </div>';
    }
...
if (!function_exists('ale_team')) {
    function ale_team( $atts, $content = null ) {
        ...
        return '<div class="ale-team '.$style.' cf">
                    <div class="imagebox">
                        <img src="'.$avatar.'" />
                    </div>
                    <div class="testititle">'.$name.'</div>
                    <div class="prof">'.$prof.'</div>
                    <div class="teamtextbox">'.do_shortcode($content).'</div>
                    <div class="socialbut">'.$fbbutton.$twibutton.$gbutton.'</div>
               </div>';
    }
...
if (!function_exists('ale_partner')) {
    function ale_partner( $atts, $content = null ) {
        ...
        return '<div class="ale-partner '.$style.' cf">
                    <div class="imagebox">
                        <a href="'.$link.'" target="_blank" title="'.do_shortcode($content).'">
                            <img src="'.$logo.'" />
                        </a>
                    </div>
                    <div class="partnertitle">'.do_shortcode($content).'</div>
                </div>';
    }
...
if (!function_exists('ale_service')) {
    function ale_service( $atts, $content = null ) {
        ...
        return '<div class="ale-service '.$style.' cf">
                    <div class="iconbox">
                        <img src="'.$icon.'" />
                    </div>
                    <div class="servicetitle">'.$name.'</div>
                    <div class="servicedescription">'.do_shortcode($content).'</div>
                </div>';
    }
        ...
        if( $address ) :
            ...
            <script type="text/javascript">
                ...
                function ale_run_map_<?php echo $map_id ; ?>(){
                    var location    = new google.maps.LatLng("<?php echo $coordinates['lat']; ?>",
